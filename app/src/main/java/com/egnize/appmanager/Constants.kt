...
object Constants {
    ...
    const val FLAG_HIDE_USER_APPS = "hide_user_apps"
    const val FLAG_ROOT_ACCESS_ALREADY_OBTAINED = "root_access_already_obtained"
    const val NIGHT_MODE = "night_mode_set"
    const val FIREBASE_PERFORMANCE_TRACE = "Search_app"

    const val FLAG_SYSTEM_APPS = "show_system_apps"
